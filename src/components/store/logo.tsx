...
/**
 * Store logo. When the admin uploads a logo image (storeconfig
 * `store.logo_public_id`), it's shown; otherwise an on-brand wordmark driven by
 * the store name, with the shopping-bag mark.
 */
export function Logo({
  ...
  return (
    ...
    >
      {logoUrl ? (
        // Admin-uploaded logo (external Cloudinary URL).
